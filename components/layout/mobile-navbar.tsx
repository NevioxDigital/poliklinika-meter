        ...
        <div className="h-full overflow-y-auto pt-28 pb-10 px-8 flex flex-col items-center">
          <div className="w-full max-w-sm space-y-10">
            ...
            <div className="space-y-8">
              {sections.map((section) => (
                <div key={section.title} className="space-y-4">
                  <h3 className=" uppercase tracking-widest text-primary/60 font-black">
                    {section.title}
                  </h3>
                  <div className="grid gap-4">
                    {section.items?.map((sub) => (
                      <Link key={sub.url} href={sub.url} className="group block">
                        <div
                          className={cn(
                            ' font-semibold',
            ...
            <div className="pt-10 border-t border-border flex flex-col gap-4 text-center">
              <p className=" text-muted-foreground">Poliklinika Meter</p>
              <div className="flex justify-center gap-4  font-medium text-primary">
