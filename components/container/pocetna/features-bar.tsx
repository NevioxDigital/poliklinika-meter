...
export const FeaturesBar = () => {
  return (
    ...
    <section className="mt-28 mb-16 md:mb-24 lg:mb-32 bg-primary-foreground/80 shadow-md relative">
          ...
          {features.map((feature, index) => (
            ...
            >
              <CardContent className="flex flex-col items-center text-center p-8">
                {/* Icon Wrapper */}
                <div className="mb-4 p-3 rounded-full bg-primary/10 group-hover:bg-white/20 transition-colors duration-300">
                  <feature.icon className="w-8 h-8 text-primary group-hover:text-white transition-colors duration-300" />
                </div>

                {/* Content */}
                <h3 className="text-lg font-bold mb-2 text-primary group-hover:text-white transition-colors duration-300">
                  {feature.title}
                </h3>
